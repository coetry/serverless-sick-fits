...
const { hasPermission } = require("../lib/util");
...
const Mutation = {
  ...
  async requestReset(parent, args, ctx, info) {
    ...
    const resetToken = (await randomBytesPromosified(20)).toString("hex");
    ...
    const mailRes = await transport.sendMail({
      ...
      <a href="${process.env.FRONTEND_URL ||
        "localhost:3000"}/reset?resetToken=${resetToken}"Click Here to Reset</a>`)
    });
